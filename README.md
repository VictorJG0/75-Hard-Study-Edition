...
- Calendar visualised as a progress bar to show how far along you are in the challenge.
...
- The reset to day 1 setting is done IMIDIATELY after the button is pressed, there is no confirmation prompt.
...
### Noted bugs
- The original 75 Hard version of the app was designed on ubuntu. After switching to arch hyprland, the app has some issues with rendering the window properly. It is still usable however it just looks a bit pixelated. This is due to arch not supporting X11. This is fixable by changing your config file at your own descretion.
